      ...
      <v-parallax height="300" class="start-image" src="../assets/Title.png">
        ...
        >
          ...
          >
            ...
            <h5 class="text-h5 subheading">
             <br>
              DATE: October 24th, 2022 <br>
              TIME: 8:00 - 12:00 (US -EST), 14:00 - 18:00 (CET - EU), 20:00 - 24:00 (CST - China)
            </h5>
          </v-col>
        </v-row>
      </v-parallax>
